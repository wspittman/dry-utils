...
export const COSMOSDB_LOG_CHANNEL = "dry-utils-cosmosdb";
export const COSMOSDB_ERR_CHANNEL = "dry-utils-cosmosdb-err";
export const COSMOSDB_AGG_CHANNEL = "dry-utils-cosmosdb-agg";
...
class Diagnostics {
  ...
  constructor() {
    this.logChannel = diagnostics_channel.channel(COSMOSDB_LOG_CHANNEL);
    this.errChannel = diagnostics_channel.channel(COSMOSDB_ERR_CHANNEL);
    this.aggChannel = diagnostics_channel.channel(COSMOSDB_AGG_CHANNEL);
  }
